...
func APIHandler(w http.ResponseWriter, req *http.Request) {
	...
	case "/api/addActivity": //添加活动
		...
		Log(fmt.Sprintln("新增活动，时间: 星期", (newActivity.Week + 1), "-", newActivity.Hour, "时 -", newActivity.Minute, "分，校区：", newActivity.District, "，地点：", newActivity.Spot, ",教室号:", newActivity.Classroom, ",备注:", newActivity.Activity, ",活动类型:", newActivity.ActivityType))
